        ...
        <div className="mx-auto p-5">
          <form onSubmit={e => onSubmit(e)}>
              ...
              <div className="row">
                ...
                <div className="col-4">
                  ...
                  <label htmlFor="email" className="form-label text-primary fw-bold">Email</label>
                    <input
                      type="email" className="form-control form-control-lg" name="email" value={email} onChange={e => onInputChange(e)} required
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="text-center mt-4">
              <button className="btn btn-primary btn-block rounded-pill" style={{marginRight: "3%"}}>Add User</button>
              <button className="btn btn-secondary btn-block rounded-pill" onClick={cancel}>Cancel</button>
            </div>
          </form>
        </div>
      </div>
